    ...
    */
    ...
    if (required.count("small")) {
        ...
        if (required["small"]["proportional"]) {
            ...
            add_pages(result, parse_ranges(project_data, file_rootdir, "small", "proportional"), input_code,
                      file_rootdir);
        }
    }
    if (required.count("large")) {
        ...
        if (required["large"]["proportional"]) {
            ...
            add_pages(result, parse_ranges(project_data, file_rootdir, "large", "proportional"), input_code,
                      file_rootdir);
        }
    }
